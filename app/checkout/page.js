      ...
      <div style={{background:'white', borderRadius:'24px', padding:'40px', width:'100%', maxWidth:'480px'}}>
        ...
        <div style={{background:'#f0fdf4', border:'1px solid #86efac', borderRadius:'12px', padding:'12px 16px', marginBottom:'16px', display:'flex', alignItems:'center', gap:'10px'}}>
          ...
          <div>
            ...
            <p style={{margin:0, color:'#15803d', fontSize:'11px', marginTop:'2px'}}>Tu pago está protegido — si algo sale mal, lo resolvemos. <a href="/guarantee" style={{color:'#15803d', fontWeight:'bold'}}>Learn more →</a></p>
          </div>
        </div>
